...
urlpatterns = [
    ...
    path(
        "votings/<int:voting_id>/voteTransferable/",
        views.vote_transferable,
    ...
    path(
        "admin/votings/<int:voting_id>/add/", views.add_candidate, name="add_candidate"
    ),
    path(
        "admin/votings/<int:candidate_id>/remove/",
        views.remove_candidate,
